...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./css/cat-emp.css">
    <title>Especificaciones de Empaque por Cliente</title>
</head>
    ...
    <main>
        <fieldset>
            ...
            <form action=   " " method="POST">
                Cliente: 
                <input type="text" name="acliente" />
                <br>
                Modelo:
                <input type="text" style="width: 328px" name="amodelo" /> <br />
