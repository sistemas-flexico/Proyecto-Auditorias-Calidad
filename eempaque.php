<!-- Script relacionado con especificaciones de empaque. -->
...
<head>
   ...
   <!-- <link href="bootstrap-4.3.1/css/bootstrap.min.css" rel="stylesheet" /> -->
    ...
    <title>Especificaciones de Empaque</title>
</head>
<bodye>
    <div class="container-fluid">
      ...
      <fieldset>
          <legend>Actualización de especificaciones de empaque</legend>
     ...
     //    echo $t_emp;
      ...
      <fieldset>
          ...
          <form action="act_eemp.php" method = "POST">
                <input type="" name="id-cliente" value = "<?php echo $idcli; ?>" />  
                Cliente: <input type="text" maxlength="28" size = "28" name="nombre" value = "<?php echo $nom; ?>" /> <br/>
                ...
                <br/>
                Tipo de empaque: <input type="number" maxlength="3" size = "3" name="tempa" value = "<?php echo $temp; ?>" /> <br/>
                Presentación 
               <select name="prese" id="">
                ...
                Especificaciones de la presentación <br/>
                ...
                <input type="text" maxlength="40" size = "40" name="eemplay" value = "<?php echo $eempla; ?>" /> <br/> 

                Cantidad final de la presentación: <input type="number"  name="cpres" value = "<?php echo $canp; ?>" /> <br/>
                ...
                <br/>
                Uso: 
                <input type="text" maxlength="50" size = "60" name="uso" value = "<?php echo $uso; ?>" /> <br/> 

                Observaciones para el proceso de acabado:  <br/> 
                <textarea name="obs_aca1" rows="10" cols="100"><?php echo $obs_aca1;?></textarea> <br/> 
                

                Observaciones para el proceso de empaque:  <br/>
                <textarea name="obs_emp1" rows="10" cols="100"><?php echo $obs_emp1;?></textarea> <br/> 
