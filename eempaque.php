...
<head>
      ...
      <link rel="stylesheet" type="text/css" href="./css/eempaque.css">
      <title>Actualización de Especificaciones</title>
</head>
...
<body>
            ...
            <div class="container-fluid">
                  <div class="row">
                        <div>
                              ...
                              <span>ACTUALIZACIÓN ESP. EMP.</span>
      ...
      <main>
            <fieldset class="fieldet1 fieldset-angosto">
                  <legend>CONSULTAR</legend>
                  <form action=" " method="POST" class="cte-mod">
                        Cliente: 
                        <input type="text" name="id-cliente" class="txt"/>
                        <br><br>
                        Modelo: 
                        <input type="text" name="modelo" class="txt"/>
                        <br><br>
            ...
            if ($t_emp > 0) {
                  while ($data = mysqli_fetch_array($queryDataemp)) {
                        ...
                        $ume = $data['um'];
                        $canp = $data['canpres'];
                        $memp = $data['medempaque'];
                        $memp2 = $data['medempaque2'];
                        $eml = $data['etiluna'];
                        $empbol = $data['emplaobol'];
                        $eempla = $data['etiempla'];
                        $matun = $data['matune'];
                        $cortes = $data['ncortes'];
                        $defec = $data['coddef'];
                        $efinal = $data['etifinal'];
                        $pfinal = $data['puntafinal'];
                        $uso = $data['uso'];
                        $obs_aca1 = $data['obs_aca1'];
                        $obs_aca2 = $data['obs_aca2'];
                        $obs_aca3 = $data['obs_aca3'];
                        $obs_aca4 = $data['obs_aca4'];
                        $obs_aca5 = $data['obs_aca5'];
                        $obs_aca6 = $data['obs_aca6'];
                        $obs_aca7 = $data['obs_aca7'];
                        $obs_aca8 = $data['obs_aca8'];
                        $obs_aca9 = $data['obs_aca9'];
                        $obs_aca10 = $data['obs_aca10'];

                        $obs_emp1 = $data['obs_emp1'];
                        $obs_emp2 = $data['obs_emp2'];
                        $obs_emp3 = $data['obs_emp3'];
                        $obs_emp4 = $data['obs_emp4'];
                        $obs_emp5 = $data['obs_emp5'];
                        $obs_emp6 = $data['obs_emp6'];
                        $obs_emp7 = $data['obs_emp7'];
                        $obs_emp8 = $data['obs_emp8'];
                        $obs_emp9 = $data['obs_emp9'];
                        $obs_emp10 = $data['obs_emp10'];
                  }
            }
            mysqli_close($con);
            ?>
            ...
            <fieldset>
                  ...
                  <form action="act_eemp.php" method="POST">
                        Cliente:
                        <input type="" name="id-cliente" value="<?php echo $idcli; ?>" class="txt2"/>
                        Nombre:
                        <input type="text" maxlength="28" size="28" name="nombre" value="<?php echo $nom; ?>" />
                        Modelo:
                        <input type="" name="modelo" value="<?php echo $mod; ?>" />
                        Códigos de los defectos que audita:
                        <input type="text" maxlength="60" size="60" name="def" value="<?php echo $defec; ?>" />
                        <br>
                        # de cortes que tolera:
                        <input type="number" maxlength="10" size="10" name="corte" value="<?php echo $cortes; ?>" />
                        Material para unir el corte:
                        <select name="matu" id="">
                        ...
                        <br>
                        Tipo de empaque: 
                        <input type="number" maxlength="3" size="3" name="tempa" value="<?php echo $temp; ?>" />
                        <br>
                        Presentación
                        ...
                        Cantidad por carrete, rollo o caja: 
                        <input type="number" name="cant" value="<?php echo $can; ?>" />
                        <select name="umed" id="">
                        ...
                        <select name="emluna" id="">
                              ...
                              <option value="Media luna blanca/amarilla" <?php echo ($eml == "Media luna blanca/amarilla") ? "selected" : ""; ?>>Media luna blanca/amarilla </option>
                        ...
                        <input type="text" maxlength="20" size="20" name="eemplay" value="<?php echo $eempla; ?>" /> <br />

                        Cantidad final de la presentación: 
                        <input type="number" maxlength="10" size="10" name="cpres" value="<?php echo $canp; ?>" />
                        <br>
                        Medida del empaque:
                        ...
                        <br>
                        Uso:
                        <input type="text" maxlength="50" size="60" name="uso" value="<?php echo $uso; ?>" />
                        <br>
                        Observaciones para el proceso de acabado:
                        <br>
                        <textarea name="obs_aca1" rows="3" cols="100"><?php echo $obs_aca1; ?></textarea>
                        <br>
                        Observaciones para el proceso de empaque:
                        <br>
                        <textarea name="obs_emp1" rows="3" cols="100"><?php echo $obs_emp1; ?></textarea>
                        <br />
                        <input type="submit" value="Guardar cambios" class="btn2">
                  </form>
            </fieldset>
      </main>
</body>
