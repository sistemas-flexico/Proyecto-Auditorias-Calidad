...
<head>
   ...
   <!-- <link href="bootstrap-4.3.1/css/bootstrap.min.css" rel="stylesheet" /> -->
    ...
    <title>Alta de Especificaciones de Empaque</title>
</head>
<bodye>
    <div class="container-fluid">
      ...
      <fieldset>
          <legend>Alta de Especificaciones de empaque</legend>
      ...
      <?php
         ...
         if($_POST){
             ...
             if ($t_clientes > 0){
                ...
                //    echo $t_emp;
                if ($t_emp > 0){
                    echo "Ya existen las especificaciones para este cliente ";                
                }
                else{ 
...
<?php if ($alta=1){   ?>
    ...
    <fieldset>
          ...
          <form action=" " method = "POST">
               ...
               Cliente <input type="hidden" name="cliente" value = "<?php echo $idcli; ?>" /> 
              ...
              Códigos de los defectos que audita: 
               ...
               <select name="prese" id="">
                ...
                Uso: 
                <input type="text" maxlength="50" size = "50" name="uso" value = "<?php echo $uso; ?>" /> <br/> 
